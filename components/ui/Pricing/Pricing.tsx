      ...
      >
        <div className=" max-w-6xl px-4 py-8 mx-auto  sm:px-6 lg:px-8">
          <div className=" sm:flex sm:flex-col sm:align-center">
            <h1
              className="mb-5 text-3xl mx-auto font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight"
            >
              Pricing Plans
            </h1>
            <p
              className="max-w-2xl m-auto mt-5 text-xl  text-body-color dark:text-body-color-dark sm:text-center sm:text-2xl"
            >
